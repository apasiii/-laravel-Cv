...
<form class="row g-3" action="{{ route('education.store') }}" method="POST">
    ...
    <div class="col-md-12">
        ...
        <input type="text" class="form-control" name="info2" id="info2" value="{{ Session::get('info2') }}">
    </div>

    <div class="col-md-12">
        <label for="info3" class="form-label">IPK</label>
        <input type="text" class="form-control" name="info3" id="info3" value="{{ Session::get('info3') }}">
    </div>
